"""Go code generator entrypoint."""

from typing import List, Union

from code_gen.utils import TypeEnum

from .common import GO_TYPE_SPECS, TIME_COST_PATH, GoMethodDef, GoClassDef
from .solution import go_generate_solution_code, go_generate_trailer_code, go_test as _go_test
from .system import go_generate_system_code, go_generate_system_trailer_code, go_system_test
