"""TypeScript code generator compatibility entrypoint."""

from typing import List, Union

from utils import TypeEnum
from ts_gen_common import TS_TYPE_SPECS, TIME_COST_PATH, TsMethodDef, TsClassDef
from ts_gen_solution import ts_generate_solution_code, ts_generate_trailer_code, ts_test as _ts_test
from ts_gen_system import ts_generate_system_code, ts_generate_system_trailer_code, ts_system_test
