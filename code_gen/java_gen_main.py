"""Java code generator compatibility entrypoint."""

from utils import TypeEnum
from java_gen_common import JAVA_TYPE_SPECS, TIME_COST_PATH, JavaMethodDef, JavaClassDef
from java_gen_solution import java_generate_solution_code, java_generate_trailer_code, java_test
from java_gen_system import java_generate_system_code, java_generate_system_trailer_code, java_system_test
