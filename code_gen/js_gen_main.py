"""JavaScript code generator compatibility entrypoint."""

from typing import List, Union

from utils import TypeEnum
from js_gen_common import JS_TYPE_SPECS, TIME_COST_PATH, JsMethodDef, JsClassDef
from js_gen_solution import js_generate_solution_code, js_generate_trailer_code, js_test as _js_test
from js_gen_system import js_generate_system_code, js_generate_system_trailer_code, js_system_test
